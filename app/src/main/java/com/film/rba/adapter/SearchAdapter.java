...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.GroceryViewHolder>{
    private List<Event> horizontalGrocderyList;
    Context context;

    public SearchAdapter(List<Event> horizontalGrocderyList, Context context){
