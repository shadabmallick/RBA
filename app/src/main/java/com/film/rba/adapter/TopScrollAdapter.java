...
public class TopScrollAdapter extends RecyclerView.Adapter<TopScrollAdapter.GroceryViewHolder>{

    ArrayList<HashMap<String,String>> wish_list;
    Context context;

    public TopScrollAdapter(ArrayList<HashMap<String,String>> wish_list, Context context){
    ...
    public GroceryViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View groceryProductView = LayoutInflater.from(parent.getContext()).inflate(R.layout.single_top, parent, false);
