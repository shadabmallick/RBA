...
public class TrendingAdapter extends RecyclerView.Adapter<TrendingAdapter.GroceryViewHolder>{
    private List<Event> horizontalGrocderyList;
    Context context;

    public TrendingAdapter(List<Event> horizontalGrocderyList, Context context){
       ...
       /* holder.time.setText(horizontalGrocderyList.get(position).getTime());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(context, TrendingActvity.class);
