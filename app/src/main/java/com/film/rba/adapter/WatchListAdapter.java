...
public class WatchListAdapter extends RecyclerView.Adapter<WatchListAdapter.GroceryViewHolder>{
    private List<Event> horizontalGrocderyList;
    Context context;

    public WatchListAdapter(List<Event> horizontalGrocderyList, Context context){
