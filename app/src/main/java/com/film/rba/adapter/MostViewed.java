...
public class MostViewed extends RecyclerView.Adapter<MostViewed.GroceryViewHolder>{
    private List<Event> horizontalGrocderyList;
    Context context;

    public MostViewed(List<Event> horizontalGrocderyList, Context context){
    ...
    public GroceryViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View groceryProductView = LayoutInflater.from(parent.getContext()).inflate(R.layout.most_watch, parent, false);
